...
class gpsr:
	...
	#self.place2 = '' 
        ...
        self.keywords_to_temp_object = {'object': ['cola','person','green-tea','potato-chips']}
        self.keywords_to_temp_locations = {'location': ['table','sofa','bookcase','shelf']}
        self.keywords_to_temp_names ={'name':['alex','lucy','john','person']}
