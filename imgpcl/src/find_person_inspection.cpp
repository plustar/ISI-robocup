...
{   
	...
	imwrite("/home/isi/2017_ws/src/imgpcl/person.jpg",inImg);//保存图片    
...
void findPersonCallback(const std_msgs::String::ConstPtr& msg)
{
    ...
    {
        //img2voiceP.data = "I have released the grocery";
        //image2voice_Pub.publish(img2voiceP);
        //img2voiceP.data = " I begin to find person";
        //image2voice_Pub.publish(img2voiceP);
        sleep(12);
        state = 0;
    }
...
{    
   ...
   // ros::Subscriber camInfo         = nh.subscribe("camera/rgb/camera_info", 1, camInfoCallback);    
    ros::Subscriber arm_sub = nh.subscribe("/nav2image", 1, findPersonCallback);        //订阅navigation的消息
    ros::spin();
