...
class gpsr:
	...
	#self.place2 = '' 
        ...
        self.keywords_to_temp_object = {'object': ['green-tea']}
	...
	if msg.data.find('turtlebot-no') > -1 : # recognized "turtlebot no"  
			###########################################################################

			###########################################################################
			self.soundhandle.say('please repeat louder and slower',self.voice)
			#self.start_recog = 0
			self.first_recog = 0
...
#	else : self.start_recog = 1
	elif msg.data.find('turtlebot-yes') > -1:  # recognized "turtlebot yes"
	...
	elif msg.data.find('turtlebot') > -1:	# recognize 'turtlebot'
		self.start_recog = 1  
	elif msg.data.find('hello') > -1:	# recognize 'turtlebot'
		self.soundhandle.say('hi,it is a good night',self.voice)
	elif msg.data.find('old') > -1 or msg.data.find('how-old') > -1:	# recognize 'turtlebot'
